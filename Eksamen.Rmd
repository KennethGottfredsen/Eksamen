...
predict(model1,data.frame(efterspørgsel=(c(10,20,30))), interval = "prediction", level = 0.95)
...
attach(data3)
lm.fit1 = lm(efterspørgsel ~ forvent_lager + weekend_helligdag + kamjunk + temp_gt25_3_dage + temp_mean_past1h + temp1 + temp2 + temp3)
...
lm.fit3 = lm(efterspørgsel ~ temp_mean_past1h^2) # melllem model. 
summary(lm.fit3)
